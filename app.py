...
def build_system_prompt(profile_text):
    return (
        ...
        “If a recruiter asks to share their email with Alessandro, confirm that their email will be notified to Alessandro’s Pushover inbox, so he can follow up directly.”
